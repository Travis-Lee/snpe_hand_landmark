...
import caffe_custom_normalize_udl
...
def udl_factory_func():
    ...
    # Instance of Udl class for mycustomnormalize layer
    udl_mycustomnormalize = snpe_udl_utils.Udl(layer_callback=caffe_custom_normalize_udl.udl_mycustomnormalize_func,
                                           expected_axes_orders=[
                                            (  # input dims
    ...
    udl_supported_types = {
        ...
        'MyCustomNormalize': udl_mycustomnormalize
    }
