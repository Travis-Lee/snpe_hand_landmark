...
SnpeUdo_ErrorType_t Softmax_QueryOperation(SnpeUdo_String_t operationType, uint32_t numOfStaticParams,
                            ...
                            uint32_t* numOfOutputs, SnpeUdo_QuantizationType_t** outputsQuantTypes,
                            SnpeUdo_HexNNTensorLayout_t** outputsLayouts);
SnpeUdo_ErrorType_t Softmax_ValidateOperation(SnpeUdo_String_t operationType, uint32_t numOfStaticParams,
                            const SnpeUdo_Param_t* staticParams);
SnpeUdo_ErrorType_t Softmax_CreateOpFactory(SnpeUdo_HexNNv2GlobalInfra_t* infra, SnpeUdo_CoreType_t udoCoreType,
                            void* perFactoryInfrastructure, SnpeUdo_String_t operationType,uint32_t numOfStaticParams,
                            SnpeUdo_Param_t* staticParams, SnpeUdo_OpFactory_t* opFactory);
SnpeUdo_ErrorType_t Softmax_ExecuteOp(SnpeUdo_HexNNv2GlobalInfra_t* infra, SnpeUdo_Operation_t operation,
...
typedef struct SoftmaxOpInfo_t {
    float* input;             // input
    uint32_t inputsLen;       // length of inputs (batch*width*height*depth)
