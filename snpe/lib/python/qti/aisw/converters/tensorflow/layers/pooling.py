...
from qti.aisw.converters.common.converter_ir.op_adapter import PoolOp
...
class PoolingLayerResolver(LayerResolver, object):
    ...
    class Descriptor(LayerDescriptor):
        def __init__(self, layer_type, name, operations, pooling_type, strides, padding_size_strategy, kernel_dims):
