...
class CropLayerResolver(LayerResolver, object):
    ...
    class Descriptor(LayerDescriptor):
        def __init__(self, name, nodes, offset, counts, size, output_names=None):
    ...
    def resolve_layer(self, graph_matcher, graph_helper):
        ...
        for match in matches:
            ...
            crop_desc = CropLayerResolver.Descriptor(str(slice_op.name), consumed_nodes, offset, counts, size)
