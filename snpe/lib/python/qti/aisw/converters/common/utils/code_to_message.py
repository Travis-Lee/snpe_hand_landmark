...
error_codes_to_messages = {
    ...
    # start of the crop_and_resize errors
    ...
    "ERROR_RESHAPE_BATCH_UNSUPPORTED": "Batch dimension greater than 1 for reshape ops is not supported",
    ...
    "ERROR_PERMUTE_TOO_MANY_DIMENSIONS": "Permute with >3 dimensions is not supported. Got {}",
    ...
    "ERROR_ELEMENTWISEBINARY_SQUASH": "Unsupported Node type for Binary Op squashing, Got: {}",
...
warning_codes_to_messages = {
    ...
    # //=============================================================================
    "WARNING_BROADCAST_ADD": "Dynamic broadcast Add operations is not supported, will attempt to interpret as a static bias-add operation",
    "WARNING_BROADCAST_SUM": "Dynamic broadcast Sum operations is not supported, will attempt to interpret as a static bias-add operation",
    "WARNING_BROADCAST_MAX": "Dynamic broadcast Max operations is not supported",
    "WARNING_BROADCAST_MIN": "Dynamic broadcast Min operations is not supported",
    "WARNING_BROADCAST_SUB": "Dynamic broadcast Sub operations is not supported, will attempt to interpret as a static bias-sub",
    "WARNING_BROADCAST_MUL": " Dynamic broadcast Mul operations is not supported, will attempt to interpret as a static scale operation",
    "WARNING_BROADCAST_DIV": " Dynamic broadcast Div operations is not supported, will attempt to interpret as a static scale operation",
    "WARNING_GEMM": "GEMM operation is not supported in the general case, attempting to interpret as FC",
    "WARNING_MATMUL": "MatMul is not supported in the general case, attempting to interpret as FC",
    ...
    # //=============================================================================
    "WARNING_STATIC_SHAPE": "Only static shape ops is supported, interpreted at conversion time {}",
...
debug_codes_to_messages = {
    ...
    "DEBUG_LSTM_SEQ_NOT_SUPPORTED": "LSTM seq_len argument is not supported, buffer_name: {}",
    ...
    "DEBUG_ELEMENTWISEBINARY_SQUASH": "Squashed ({}, type: {}) into ({}, type: {})",
