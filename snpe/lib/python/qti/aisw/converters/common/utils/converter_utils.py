...
# TODO: Temporary location until Custom Op Refactor
class CustomOpBackend(Enum):
    """
    Describes the type of custom op for the backends available to all converters
    """
    SNPE_UDO = 0
    QNN_UDO = 1