...
def convert_to_dlc(pb_filename, model_dir, tensorflow_dir, runtime, udo):
...
def setup_assets(inception_v3_data_dir, download, runtime, udo):
    ...
    convert_to_dlc(pb_filename, model_dir, tensorflow_dir, runtime, udo)
...
if __name__ == '__main__':
    ...
    try:
        setup_assets(args.assets_dir, args.download, args.runtime, args.udo)
    except Exception as err:
        sys.stderr.write('ERROR: %s\n' % str(err))